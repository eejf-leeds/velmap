...
%JF
plt_data(lon_grid,lat_grid,egrid,gps,strainmap.lonlims,strainmap.latlims,[-15 15],borders,places,'East vel (mm/yr)', faults)%, poly)
colormap(ax, vik)

ax = nexttile; hold on
% plt_data(lon,lat,ngrid,gps,strainmap.lonlims,strainmap.latlims,[-30, 30],borders,places,'North vel (mm/yr)', faults)%, poly)
%JF
plt_data(lon_grid,lat_grid,ngrid,gps,strainmap.lonlims,strainmap.latlims,[-30, 30],borders,places,'North vel (mm/yr)', faults)%, poly)
colormap(ax, vik)

ax = nexttile; hold on
% plt_data(lon,lat,ugrid,gps,strainmap.lonlims,strainmap.latlims,[-15, 15],borders,places,'Up vel (mm/yr)', faults)%, poly)
%JF
plt_data(lon_grid,lat_grid,ugrid,gps,strainmap.lonlims,strainmap.latlims,[-15, 15],borders,places,'Up vel (mm/yr)', faults)%, poly)
colormap(ax, vik)
