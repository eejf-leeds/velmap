function [insarfit] = insarfwd_1by1(insar,trim,fitmodel,invenu,outdir,gps)
%========================================================
...
ninsar=length(insar);
for i=1:ninsar
fprintf('\nWorking on InSAR data %d/%d\n',i,ninsar)
insarmat=designinterp(trim,insar(i),0,invenu);
